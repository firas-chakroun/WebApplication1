...
namespace WebApplication1.Controllers
{
    public class ProductController : Controller
    {
        ...
        {
            var product =ProductRepositry.Get(id);
            return View(product);
        }
        ...
        public ActionResult Create(CreateViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                ProductRepositry.Add(newProduct);
        ...
        {
            Product product = ProductRepositry.Get(id);
        ...
        public ActionResult Edit(EditViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                Product product = ProductRepositry.Get(model.Id);
                ...
                Product updatedProduct = ProductRepositry.Update(product);
        ...
        {
            return View(ProductRepositry.Get(id));
        }
